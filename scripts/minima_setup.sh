...
wget -q -O $HOME"/minima_service.sh" "https://github.com/minima-global/Minima/raw/release-0.102/scripts/minima_service.sh"
...
rm -Rf /home/minima/.minima_$PORT
rm -Rf /etc/cron.weekly/minima_*
