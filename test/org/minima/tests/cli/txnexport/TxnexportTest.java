...
public class TxnexportTest extends MinimaCliTest {

    @Test
    public void testTxnexportWithNoArgs () throws Exception
    {
        String output = super.minimaTestNode.runCommand("txnexport");
        runBaseTests(output);        
    }
