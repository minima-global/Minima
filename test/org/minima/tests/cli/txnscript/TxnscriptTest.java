...
public class TxnscriptTest extends MinimaCliTest {

    @Test
    public void testTxnscriptWithNoArgs () throws Exception
    {
        String output = super.minimaTestNode.runCommand("txnscript");
        runBaseTests(output);        
    }
