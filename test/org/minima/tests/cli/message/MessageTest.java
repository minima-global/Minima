package org.minima.tests.cli.message;
...
public class MessageTest extends MinimaCliTest {

    @Test
    public void testMessageWithNoArgs() throws Exception {
        String output = minimaTestNode.runCommand("message");
        runBaseTests(output);
    }
