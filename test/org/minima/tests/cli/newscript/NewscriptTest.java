package org.minima.tests.cli.newscript;
...
public class NewscriptTest extends MinimaCliTest {
    ...
    */ 
    ...
    @Test
    public void testNewscriptWithNoArgs () throws Exception
    {
        String output = super.minimaTestNode.runCommand("newscript");
        runBaseTests(output);        
    }
