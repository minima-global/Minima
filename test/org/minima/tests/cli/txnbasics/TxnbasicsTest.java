package org.minima.tests.cli.txnbasics;
...
public class TxnbasicsTest extends MinimaCliTest {

    @Test
    public void testTxnbasicsWithNoArgs () throws Exception
    {
        String output = super.minimaTestNode.runCommand("txnbasics");
        runBaseTests(output);        
    }
