...
public class MiniNumberTests {
    ...
    public void testValues() {
      ...
      assertFalse("should not be null", i.increment().setSignificantDigits(2).isEqual(MiniNumber.TWO));
      assertFalse("should be greater than num 0", i.increment().isLess(MiniNumber.ONE));
      assertFalse("should be greater than num 0", i.increment().isMore(MiniNumber.ONE));
      assertFalse("should be greater than num 0", i.isMoreEqual(MiniNumber.ONE));
