...
public class HexValueTests {
    ...
    public void testConstructors() {
        ...
        assertEquals(HexValue.VALUE_HEX, hv1.getValueType(), "should be equal ");
        assertEquals(HexValue.VALUE_HEX, hv2.getValueType(), "should be equal ");
        assertEquals(HexValue.VALUE_HEX, hv4.getValueType(), "should be equal ");
        assertEquals(HexValue.VALUE_HEX, hv5.getValueType(), "should be equal ");
        assertEquals(HexValue.VALUE_HEX, hv6.getValueType(), "should be equal ");
        assertEquals(HexValue.VALUE_HEX, hv7.getValueType(), "should be equal ");
        assertEquals(HexValue.VALUE_HEX, hv8.getValueType(), "should be equal ");
        assertEquals(HexValue.VALUE_HEX, hv9.getValueType(), "should be equal ");
    }
    ...
    public void testComaprisons() {
        ...
        while (true) {
            ...
            assertTrue(hv1.isEqual(hv2), "should be true ");
            assertTrue(hv2.isEqual(hv1), "should be true ");
...
//            assertTrue("should be true ", hv2.isMoreEqual(hv1));
        ...
        while (true) {
            ...
            assertFalse(hv1.isEqual(hv2), "should be false ");
            assertFalse(hv1.isEqual(hv2), "should be false ");
