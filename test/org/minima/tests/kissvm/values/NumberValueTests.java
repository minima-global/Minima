...
//        NumberValue nv3a = new NumberValue(Double.toString(doubleNumber));
        ...
        assertEquals(nv1.getNumber().getAsInt(), nv1a.getNumber().getAsInt(), "should be equal ");
        assertEquals(nv2.getNumber().getAsLong(), nv2a.getNumber().getAsLong(), "should be equal ");
//        assertTrue("should be true ", nv3.getNumber().getAsDouble() == nv3a.getNumber().getAsDouble());
        assertEquals(nv4.getNumber().getAsBigInteger(), nv4a.getNumber().getAsBigInteger(), "should be equal ");

        assertEquals(NumberValue.VALUE_NUMBER, nv1.getValueType(), "should be equal ");
        assertEquals(NumberValue.VALUE_NUMBER, nv1a.getValueType(), "should be equal ");
        assertEquals(NumberValue.VALUE_NUMBER, nv2.getValueType(), "should be equal ");
        assertEquals(NumberValue.VALUE_NUMBER, nv2a.getValueType(), "should be equal ");
...
//        assertEquals("should be equal ", NumberValue.VALUE_NUMBER, nv3a.getValueType());
    ...
    public void testArithmentic() {
        ...
        assertTrue(nv1.add(nv2).isEqual(res), "should be true ");
        assertTrue(nv2.add(nv1).isEqual(res), "should be true ");
        ...
        assertFalse(res.getNumber().isEqual(new MiniNumber(Long.MAX_VALUE)), "should be false ");
        assertTrue(nv1.add(nv2).isEqual(res), "should be true ");
        assertTrue(nv2.add(nv1).isEqual(res), "should be true ");
        ...
        assertTrue(nv1.sub(nv2).isEqual(res), "should be true ");

        nv1 = new NumberValue(123456789);
        nv2 = new NumberValue(23456789);
        res = new NumberValue(100000000);
        assertTrue(nv1.sub(nv2).isEqual(res), "should be true ");
        assertFalse(nv2.sub(nv1).isEqual(res), "should be false ");
        ...
        nv2 = new NumberValue(0);
        res = new NumberValue(0);
        assertTrue(nv1.mult(nv2).isEqual(res), "should be true ");

        nv1 = new NumberValue(12345);
        nv2 = new NumberValue(67890);
        res = new NumberValue(838102050);
        assertTrue(nv1.mult(nv2).isEqual(res), "should be true ");
        assertTrue(nv2.mult(nv1).isEqual(res), "should be true ");
        ...
        nv2 = new NumberValue(1);
        res = new NumberValue(0);
        assertTrue(nv1.div(nv2).isEqual(res), "should be true ");
...
//                    break;
            ...
            assertFalse(nv1.isLess(nv2), "should be false ");
            assertFalse(nv2.isLess(nv1), "should be false ");
            assertTrue(nv1.isLessEqual(nv2), "should be true ");
            assertTrue(nv2.isLessEqual(nv1), "should be true ");
            assertFalse(nv1.isMore(nv2), "should be false ");
            assertFalse(nv2.isMore(nv1), "should be false ");
            assertTrue(nv1.isMoreEqual(nv2), "should be true ");
            assertTrue(nv2.isMoreEqual(nv1), "should be true ");
        }
...
//                    break;
            ...
            assertTrue(nv1.isLess(nv2), "should be true ");
            assertFalse(nv2.isLess(nv1), "should be false ");
            assertTrue(nv1.isLessEqual(nv2), "should be true ");
            assertFalse(nv2.isLessEqual(nv1), "should be false ");
            assertFalse(nv1.isMore(nv2), "should be false ");
            assertTrue(nv2.isMore(nv1), "should be true ");
            assertFalse(nv1.isMoreEqual(nv2), "should be false ");
            assertTrue(nv2.isMoreEqual(nv1), "should be true ");
        }
...
//                    });
    ...
    public void testToString() {
        ...
        assertEquals(Integer.toString(0), nv.toString(), "should be equal ");
        nv = new NumberValue(Long.valueOf(0));
        assertEquals(Long.toString(0), nv.toString(), "should be equal ");
        ...
        assertEquals(Integer.toString(1), nv.toString(), "should be equal ");
        nv = new NumberValue(Long.valueOf(1));
        assertEquals(Long.toString(1), nv.toString(), "should be equal ");
        ...
        assertEquals(Integer.toString(Integer.MIN_VALUE), nv.toString(), "should be equal ");
        ...
        assertEquals(Integer.toString(Integer.MAX_VALUE), nv.toString(), "should be equal ");
