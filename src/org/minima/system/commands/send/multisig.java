...
public class multisig extends Command {
	...
	public String getFullHelp() {
		return "\nmultisig\n"
				...
				+ "    getkey : returns one of your default public keys\n"
				...
				+ "\n"
				+ "id: (optional)\n"
				+ "    Create a multisig coin with an id or by id.\n"
				...
				+ "\n"
				+ "required: (optional)\n"
				+ "    The minimum number of public keys from the list required to sign the transaction.\n"
				+ "\n"
				+ "coinid: (optional)\n"
				...
				+ "Examples:\n"
				+ "\n"
				+ "multisig action:create id:2of3multisig amount:100 publickeys:[\"0xFED5..\",\"0xABD6..\",\"0xFD8B..\"] required:2\n"
				+ "\n"
