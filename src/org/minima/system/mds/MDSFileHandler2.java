...
public class MDSFileHandler2 implements Runnable {
	 ...
	 * @param zSocket
	 */
	public MDSFileHandler2(File zRootFolder, Socket zSocket, MDSManager zMDS) {
		//Store..
		mSocket = zSocket;
		mRoot 	= zRootFolder;
		mMDS 	= zMDS;
	...
	public void run() {
		...
		try {
			...
			if(fileRequested.equals("") || fileRequested.equals("index.html")) {
				...
				//Write the page
				writeHTMLPage(dos, MDSHubLoggedOn.createHubPage(mMainSessionID,"main.html"));
