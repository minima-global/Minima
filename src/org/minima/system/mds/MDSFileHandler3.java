...
public class MDSFileHandler3 implements Runnable {
	 ...
	 * @param zSocket
	 */
	public MDSFileHandler3(File zRootFolder, Socket zSocket, MDSManager zMDS) {
		//Store..
		mSocket = zSocket;
		mRoot 	= zRootFolder;
		mMDS 	= zMDS;
	...
	public void run() {
		...
		try {
			...
			if(fileRequested.equals("") || fileRequested.equals("index.html")) {
				...
				//Write the page
				writeHTMLPage(dos, MDSHubLoggedOn.createHubPage(mMainSessionID,base));
