...
public class MDSManager extends MessageProcessor {
	...
	private void doDefaultMiniHUB() throws Exception {
		...
		//Check for HUB
		checkInstalled("minihub", "minihub/minihub-0.5.9.mds.zip", allminis, true, true);
		...
		if(GeneralParams.DEFAULT_MINIDAPPS) {
			...
			checkInstalled("security", "default/security-0.6.4.mds.zip", allminis, true);
			...
			checkInstalled("health", "default/health-1.0.0.mds.zip", allminis, false);
