...
public class MDSManager extends MessageProcessor {
	...
	private void doDefaultMiniHUB() throws Exception {
		...
		//Check for HUB
		checkInstalled("minihub", "minihub/minihub-0.12.11.mds.zip", allminis, true, true);
		...
		if(GeneralParams.DEFAULT_MINIDAPPS) {
			...
			checkInstalled("security", "default/security-0.23.1.mds.zip", allminis, true);
			...
			checkInstalled("future cash", "default/futurecash-2.0.0.mds.zip", allminis, false);
