...
public class MDSManager extends MessageProcessor {
	...
	private void doDefaultMiniHUB() throws Exception {
		...
		if(GeneralParams.DEFAULT_MINIDAPPS) {
			...
			//The rest are normal
			checkInstalled("block", "default/block-2.1.2.mds.zip", allminis, false);
			...
			checkInstalled("future cash", "default/futurecash-2.3.3.mds.zip", allminis, false);
			...
			checkInstalled("wallet", "default/wallet-2.33.1.mds.zip", allminis, false);
		}
	}
