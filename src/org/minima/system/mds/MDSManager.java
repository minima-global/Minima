...
public class MDSManager extends MessageProcessor {
	...
	private void doDefaultMiniHUB() throws Exception {
		...
		if(GeneralParams.DEFAULT_MINIDAPPS) {
			...
			checkInstalled("security", "default/security-0.17.2.mds.zip", allminis, true);
			
			//Dappstore gets write permissions
			checkInstalled("dapp store", "default/dapp_store-1.0.5.mds.zip", allminis, true);
			...
			checkInstalled("maxcontacts", "default/maxcontacts-1.7.1.mds.zip", allminis, false);
