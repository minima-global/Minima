...
public class MDSHubPendingAction {
	...
	public static String createHubPage(MDSManager zMDS, String zPassword, boolean zAccept, String zOuput) {
		...
		//Now the return form..
		page += 
				  "	<br><br><br><form action=\"pending.html\" method=\"post\">\r\n"
				+ "		<input type='hidden' name='password' value='"+zPassword+"'/>\r\n"
				+ "		<input class='solobutton' style='width:200;' type=\"submit\" value='Back to Pending Actions' onClick=\"this.form.submit(); this.disabled=true; this.value='Checking..';\"/>\r\n"
				+ "	</form>\r\n"
				+ "</center>"
				+ ""
