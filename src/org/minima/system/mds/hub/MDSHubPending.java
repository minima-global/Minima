...
public class MDSHubPending {
	...
	public static final String HUB_END ="</ul>\n"
			+ "    </div>\n"
			+ "\n"
			+ "</body>\n"
			+ "\n"
	...
	public static String createHubPage(MDSManager zMDS, String zPassword) {
		...
		page +=   "<center>"
				...
				+ "			<input class='solobutton' style='width:200;' onClick=\"this.form.submit(); this.disabled=true; this.value='Checking..';\" type=\"submit\" value='&nbsp;&nbsp;Main Menu&nbsp;&nbsp;'>\r\n"
				+ "		</form>"
				+ "</div>"
				+ "</center>";
