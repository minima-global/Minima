...
import org.minima.system.network.base.ssz.TreeNodeImpl.BranchNodeImpl;
...
public interface BranchNode extends TreeNode {
  ...
  default Bytes32 hashTreeRoot() {
    byte[] hash = (new Crypto()).hashSHA2(Bytes.concatenate(left().hashTreeRoot(), right().hashTreeRoot()).toArray());
