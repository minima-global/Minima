...
//	RPCServer mRPCServer;
    ...
    public NetworkHandler(String zHost, int zMainPort) {
        ...
        try {
            ...
            MinimaLogger.log("MiniDAPP server error " + e);
        } catch (KeyStoreException e) {
            MinimaLogger.log("MiniDAPP KeyStoreException " + e);
        } catch (NoSuchAlgorithmException e) {
            MinimaLogger.log("MiniDAPP NoSuchAlgorithmException " + e);
        } catch (UnrecoverableKeyException e) {
            MinimaLogger.log("MiniDAPP UnrecoverableKeyException " + e);
        } catch (CertificateException e) {
            MinimaLogger.log("MiniDAPP CertificateException " + e);
        } catch (java.lang.Exception e) {
            MinimaLogger.log("MiniDAPP SSL create error " + e);
        }
    }
