...
public class MMRSet2 implements Streamable {
	...
	public MMRSet2(int zBitLength) {
		this(null, zBitLength);
	}
	
	public MMRSet2(int zBitLength, boolean zUseMMREntryDB) {
		this(null, zBitLength,zUseMMREntryDB);
	}
	
	public MMRSet2(MMRSet2 zParent) {
		this(zParent, 512);
	}
	
	public MMRSet2(MMRSet2 zParent, int zBitLength) {
		this(zParent,zBitLength,true);
	}
	
	public MMRSet2(MMRSet2 zParent, int zBitLength, boolean zUseMMREntryDB) {
		//All the Entries in this set
	...
	public void setParent(MMRSet2 zParent) {
		mParent = zParent;
	}
...
//			MMRData data = new MMRData(combined,sumvalue);
			...
			//Set the Parent
			entry = setEntry(entry.getParentRow(), entry.getParentEntry(), parent);
...
//	}
	...
	public boolean checkProof(MMRProof zProof) {
		...
		MMRSet2 proofset = getParentAtTime(zProof.getBlockTime());
...
//			}
	 ...
	 */
	public MMRSet2 getParentAtTime(MiniNumber zTime) {
		MMRSet2 current = this;
...
//			int testsize = 8;
			...
			//New set for each test
			MMRSet2 testset = new MMRSet2(160, false);
