...
public class MegaMMR implements Streamable {
	 ...
	 */
	public void scanUnspendable() {
		
		MinimaLogger.log("All Coins size : "+mAllUnspentCoins.size());
	...
	/**
	 * Can we PRUNE this coin - may even check a custom blacklist.. ?
	 */
