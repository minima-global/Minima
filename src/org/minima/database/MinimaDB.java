...
public class MinimaDB {
	...
	public void DoGenesis() {
		...
		MMRData gendata = new MMRData(false, gencoin, null, MiniNumber.ZERO, new ArrayList<StateVariable>());
...
//			TxPoW txpow = row.getTxPOW();
//			
//			//Check fopr tokens if has a valid body
...
//			MMRProof proof = proofmmr.getProof(entrynum,true);
			//Only need to the Peak! - smaller..
			MMRProof proof = proofmmr.getProofToPeak(entrynum,true);
